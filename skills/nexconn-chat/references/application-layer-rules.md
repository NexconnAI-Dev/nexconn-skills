...
- Only enable mention triggers in channel types that support mentions (Group ✅, Community ✅, Direct ❌, Open ❌); see the channel feature matrix at [Channel Guide](https://docs.nexconn.ai/guides/realtime-chat/intro-chat/im-feature-basic.md).
...
If the user's intent is "really get rid of those channels" (not just hide), confirm whether they mean leave-channel or dissolve-channel (see the [Channel Guide](https://docs.nexconn.ai/guides/realtime-chat/intro-chat/im-feature-basic.md) terminology section).
